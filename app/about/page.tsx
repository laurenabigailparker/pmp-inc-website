  ...
  const faqs = [
    {
      ...
      answer:
        "PMP Inc is a luxury concierge and curated connection brand. We help clients access trusted professionals, refined services, and intentional support across lifestyle, design, home, and business needs.",
    },
    {
  ...
  return (
    <main className="bg-[#5b4636] text-[#f3eee7]">
      <section className="relative min-h-[85svh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[85svh] max-w-7xl items-end px-8 py-20 md:px-12 lg:px-16 lg:py-24">
          ...
          <div className="mt-20 grid gap-px bg-[rgba(243,238,231,0.12)] md:grid-cols-2 xl:grid-cols-4">
            {pillars.map((item, index) => (
              <Reveal key={item.title} delay={index * 120}>
                <div className="bg-[#5b4636] px-8 py-12 transition hover:bg-[#675140]">
      ...
      <section className="bg-[#f3eee7] px-8 py-24 text-[#5b4636] md:px-12 lg:px-16 lg:py-32">
        <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:gap-24">
          <div className="group relative min-h-[560px] overflow-hidden border border-[rgba(91,70,54,0.12)]">
           <Image
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="pr-6 text-lg uppercase tracking-[0.03em]">
                      {faq.question}
                    </span>
                  ...
                  {isOpen && (
                    <div className="px-6 pb-6 leading-8 text-[#efe7dd]">
                      {faq.answer}
                    </div>
                  )}
                </div>
